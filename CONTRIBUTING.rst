...
Welcome to ``telegram-forward`` contributor's guide.
...
If you experience bugs or general issues with ``telegram-forward``, please have a look
...
You can help improve ``telegram-forward`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``telegram-forward`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``telegram-forward``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n telegram-forward python=3 six virtualenv pytest pytest-cov
    conda activate telegram-forward
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/telegram-forward.git
    cd telegram-forward
...
#. Install |pre-commit|_::
   ...
   ``telegram-forward`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/telegram-forward
.. _issue tracker: https://github.com/<USERNAME>/telegram-forward/issues
.. <-- end -->
